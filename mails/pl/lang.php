...
$_LANGMAIL['New credit slip regarding your order'] = 'Nowa korekta płatności dotycząca zamówienia';
...
$_LANGMAIL['Your order return state has changed'] = 'Nowy status zwrotu zamówienia';
...
$_LANGMAIL['Newsletter voucher'] = 'Kod rabatowy za zapisanie się do Newslettera';
$_LANGMAIL['Your wishlist\\\'s link'] = 'Link do Twojej listy życzeń';
// $_LANGMAIL['Message from '] = 'Message from ';
// $_LANGMAIL['$subject'] = '';
$_LANGMAIL['Your cart and your discount'] = 'Twój koszyk i Twój kod rabatowy';
...
$_LANGMAIL['Product available'] = 'Interesujący Cię produkt jest już dostępny';
...
// Angielski plik konczy sie na lini 61
$_LANGMAIL['Email verification'] = 'E-mail weryfikacyjny';
$_LANGMAIL['Stock coverage'] = 'Aktualne pokrycie stanu';
$_LANGMAIL['%1$s sent you a link to %2$s'] = '%1$s wysłał Ci link do %2$s';
$_LANGMAIL['Process the payment of your order'] = 'Dokonaj płatności za zamówienie';
...
$_LANGMAIL['Your message has been correctly sent #ct%1$s #tc%2$s'] = 'Przesłałeś wiadomość #ct%1$s #tc%2$s';
